...
interface MarkOperationToolbarState {
...
export class MarkOperationToolbar extends React.Component<MarkOperationToolbarProps, MarkOperationToolbarState> {
  private toolbarRef = React.createRef<HTMLDivElement>();

  constructor(props: MarkOperationToolbarProps) {
    super(props);
    this.state = {
      activePanel: null,
      fontSize: 14,
