    ...
    static createPane(
        ...
        switch (indicatorType) {
            case SubChartIndicatorType.VOLUME:
                return new VolumePane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.RSI:
                return new RSIPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.MACD:
                return new MACDPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.STOCHASTIC:
                return new StochasticPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.SAR:
                return new SARPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.KDJ:
                return new KDJPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.ATR:
                return new ATRPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.CCI:
                return new CCIPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.BBWIDTH:
                return new BBWidthPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.ADX:
                return new ADXPane(id, size, vertPosition, indicatorType, paneInstance);
            case SubChartIndicatorType.OBV:
                return new OBVPane(id, size, vertPosition, indicatorType, paneInstance);
            default:
                return new RSIPane(id, size, vertPosition, indicatorType, paneInstance);
        }
    }
