...
export class MarketProfile {
    ...
    constructor(chartLayer: Chart, i18n: I18n, theme: ThemeConfig, closeCallBack: () => void) {
    ...
    private initializeMarketProfile(chartLayer: Chart, i18n: I18n, theme: ThemeConfig): void {
