...
export class IchimokuIndicator extends BaseIndicator {
  ...
  static calculate(data: ICandleViewDataPoint[], mainChartIndicatorInfo?: MainChartIndicatorInfo): any[] {
    ...
    const conversionParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Tenkan');
    const baseParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Kijun');
    const leadingParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Senkou');
    const laggingParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Chikou');
  ...
  private createSeries(chart: IChartApi, mainChartIndicatorInfo: MainChartIndicatorInfo): void {
    ...
    const tenkanParam = params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('tenkan')) || params[0];
    ...
    const kijunParam = params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('kijun')) || params[1] || params[0];
    ...
    const chikouParam = params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('chikou')) || params[2] || params[0];
    ...
    const senkouAParam = params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('senkoua') || p.paramName.toLowerCase().includes('senkou a')) || params[3] || params[0];
    ...
    const senkouBParam = params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('senkoub') || p.paramName.toLowerCase().includes('senkou b')) || params[4] || params[0];
  ...
  private getParamColor(mainChartIndicatorInfo: MainChartIndicatorInfo | undefined, paramName: string): string | null {
    ...
    const param = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === paramName);
