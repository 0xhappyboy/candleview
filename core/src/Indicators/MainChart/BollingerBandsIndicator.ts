...
export class BollingerBandsIndicator extends BaseIndicator {
  ...
  static calculate(data: ICandleViewDataPoint[], mainChartIndicatorInfo?: MainChartIndicatorInfo): any[] {
    ...
    const periodParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Period') ||
      mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Middle');
    const multiplierParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Multiplier') ||
      mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Upper');
  ...
  addSeries(chart: IChartApi, data: ICandleViewDataPoint[], mainChartIndicatorInfo?: MainChartIndicatorInfo): boolean {
    try {
      ...
      const middleParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('middle')) || mainChartIndicatorInfo.params[0];
