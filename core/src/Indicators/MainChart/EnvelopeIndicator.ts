...
export class EnvelopeIndicator extends BaseIndicator {
  ...
  static calculate(data: ICandleViewDataPoint[], mainChartIndicatorInfo?: MainChartIndicatorInfo): any[] {
    ...
    const upperParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Upper');
    const middleParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Middle');
    const lowerParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName === 'Lower');
  ...
  addSeries(chart: IChartApi, data: ICandleViewDataPoint[], mainChartIndicatorInfo?: MainChartIndicatorInfo): boolean {
    try {
      ...
      const upperParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('upper')) || mainChartIndicatorInfo.params[0];
      const middleParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('middle') || p.paramName.toLowerCase().includes('sma')) || mainChartIndicatorInfo.params[0];
      const lowerParam = mainChartIndicatorInfo.params.find((p: MainChartIndicatorParam) => p.paramName.toLowerCase().includes('lower')) || mainChartIndicatorInfo.params[0];
