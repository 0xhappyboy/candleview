...
export default function PrivacyPolicyPage() {
    ...
    const content = {
        en: {
            ...
            introduction: "This Privacy Policy describes how ChartFin collects, uses, and shares your personal information when you use our services. We are committed to protecting your privacy and handling your data with transparency and care.",
            ...
            contactUs: {
                title: "Contact Us",
                content: "If you have questions about this Privacy Policy or your personal data, contact us at: privacy@chartfin.com"
            }
        },
        cn: {
            title: "隐私政策",
            lastUpdated: "最后更新：2024年12月",
            introduction: "本隐私政策描述了 ChartFin 在您使用我们服务时如何收集、使用和共享您的个人信息。我们致力于保护您的隐私，并以透明和谨慎的方式处理您的数据。",
            ...
            contactUs: {
                title: "联系我们",
                content: "如果您对本隐私政策或您的个人数据有任何疑问，请通过以下方式联系我们：privacy@chartfin.com"
            }
        }
    };
